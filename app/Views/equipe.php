    ...
    <div class="bann-content">
        <!-- <div class="grid-me">
            ...
            <div class="equipe border-me">
                <img src="<?php echo base_url('image/dr.png'); ?>" alt="docteur nutrithérapeute" class="standard-image prez02" style="border-bottom: double 4px var(--color07); max-width: 350px;">   
        ...
        <div class="bann-content02">
            ...
            <div class="equipe border-me">
                <h3>Un personnel administratif</h3>
                <ul>
        ...
        <div class="bann-content02">
            <div class="equipe border-me">
                <h3>Un coach en Zumba senior</h3>
                <ul>
            ...
            <div class="equipe border-me">
                <h3 style="display: inline-block">Un coach en Gym douce </h3><span> (Séance spéciale pour les Ainés)</span>
                <ul>
