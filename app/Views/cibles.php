    ...
    <div class="bann-content">
        ...
        <div class="border-me mytext02">
            <ol>
                ...
                <li>Des malades atteints d’Alzheimer au stade de début :
                    <ul>
                        <li>pour éviter la progression de la maladie ou même l’améliorer</li>
                    </ul>
                </li>
                <li>
                    Des malades atteints de la maladie de Parkinson au stade de début ou pas :
                    <ul>
                        <li>pour stimuler leur renforcement musculaire</li>
                        <li>pour diminuer la progression de la maladie ou même la maîtriser</li>
                    </ul>
                </li>
                <li>Des personnes âgées souffrant des douleurs articulaires ou de dos chroniques :
                    <ul>
