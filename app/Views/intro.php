<section>
    <div class="bann-content intern01">
        ...
        <div class="approche">
            ...
            <div class="grid-me">
                <div class="vide"></div>
                <img src="<?php echo base_url('image/approche01.jpg') ?>" class="standard-image border-me02 sec01" alt="personnes agées dans piscine">
                <p class="sec02">
                Notre approche chez Shalom - Maison d'Accueil est unique et innovante. Nous nous engageons à améliorer la qualité de vie de nos résidents en leur offrant des soins personnalisés et attentifs. Notre équipe travaille ensemble pour garantir une approche globale à la santé de nos résidents. Nous accordons une attention particulière à l'alimentation, en proposant des options adaptées à leurs besoins nutritionnels grâce à la Nutrithérapie, ainsi qu'à l'activité physique, en proposant des activités telles que la gymnastique douce pour favoriser le renforcement musculaire et le maintien de l'équilibre. 
